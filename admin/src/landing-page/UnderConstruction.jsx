                 ...
                 <div className="coming-soon regular-cursor">
                     ...
                     <ul className="middle-container-soon">
                         ...
                         <li className="coming-soon-btn-container">
                                 <input id="backToAOS" onClick={this.redirectToLinks} className="coming-soon-buttons pointer-cursor ie-modification-btn" style={{marginBottom:"30px"}} defaultValue="Back To AOS" />
