            ...
            <div className='nav-space-between'>
                ...
                <p className="aos-nav-headline">Download Mobile Apps</p>
                        ...
                        <div className="nav_download_wrapper">
                            <a className="devices nav_download_container" style={{float:'left' ,'marginBottom': '16px'}} href='https://s3.amazonaws.com/aos-on-prem-downloads/3.1/Advantage+demo+3.1.ipa'>
                                ...
                                <a className="devices nav_download_container" href='https://s3.amazonaws.com/aos-on-prem-downloads/3.1/Advantage+demo+3.1.apk'>
                                    <div className="devices_pic">
