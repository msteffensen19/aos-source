...
import com.advantage.account.dao.AccountRepository;
import com.advantage.account.dao.DefaultAccountRepository;
...
public class AccountService {
    ...
    @Transactional(readOnly = true)
    public AccountResponseStatus doLogin(final String loginUser, final String loginPassword, final String email) {
