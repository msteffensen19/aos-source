...
@XmlRootElement(name = "UpdateDemoAppConfigParameterResponse")
public class UpdateDemoAppConfigParameterResponse {

    @XmlElement(name = "StatusMessage", required = true)
    protected UpdateDemoAppConfigParameterResponse.StatusMessage statusMessage;
     ...
     * @return
     *     possible object is
     *     {@link UpdateDemoAppConfigParameterResponse.StatusMessage }
     *     
     */
    public UpdateDemoAppConfigParameterResponse.StatusMessage getStatusMessage() {
     ...
     *     
     */
    public void setStatusMessage(UpdateDemoAppConfigParameterResponse.StatusMessage value) {
