...
public class DataSourceConfiguration {
    ...
    public static final String ENV_DB_URL_HOST = "order.hibernate.db.url.host";
    public static final String ENV_DB_URL_PORT = "order.hibernate.db.url.port";
    public static final String ENV_DB_URL_NAME = "order.hibernate.db.name";
