...
package com.advantage.root.store.user.dao;

import com.advantage.root.store.user.config.AppUserConfiguration;
import com.advantage.root.store.user.dto.AppUserResponseStatus;
import com.advantage.root.store.user.model.AppUser;
import com.advantage.root.util.JPAQueryHelper;
import com.advantage.root.store.dao.AbstractRepository;
import com.advantage.root.store.user.util.ValidationHelper;
