...
import static com.advantage.root.store.user.util.ValidationHelper.isAuthorized;

@Aspect
public class ApiSecurityMethodInvokeAspect {
    @Around("execution(* *(..)) && @annotation(com.advantage.root.store.log.AppUserAuthorize)")
