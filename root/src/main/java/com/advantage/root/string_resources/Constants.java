...
public class Constants {
    ...
    //TODO-EVG remove
    static final String URI_SERVER_ORDER = "http://localhost:8080/order" + URI_API + "/v1";
    ...
    static final String URI_SERVER_CATALOG = "http://localhost:8080/catalog" + URI_API + "/v1";
    ...
    static final String URI_SERVER_ACCOUNT = "http://localhost:8080/account" + URI_API + "/v1";
    ...
    static final String URI_SERVER_SHIP_EX = "http://localhost:8080/ShipEx";
