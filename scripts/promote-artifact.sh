PATH=/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/usr/java/jdk1.8.0_74/jre:/usr/java/jdk1.8.0_74/jre:/opt/apache-maven-3.3.9/bin/:/opt/node-v4.4.0-linux-x64/bin/
