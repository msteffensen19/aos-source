...
public class ShoppingCartResponseDto {
    ...
    public ShoppingCartResponseDto() { super(); }

    public ShoppingCartResponseDto(long userId) { this.userId = userId; }
    ...
    public List<CartProduct> getProductsInCart() { return this.productsInCart; }
